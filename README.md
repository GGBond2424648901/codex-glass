...
> **4.2.0 更新**：新增主代理 / 子代理实时模型调用状态，展开即可查看每个代理的请求模型与有证据的响应模型；不猜测日志没有记录的下游模型。同步修复缩放、低额度视觉、零用量状态与圆角透明回归。Windows 270 项测试通过。[更新记录](CHANGELOG.md) · [验收记录](docs/VERIFICATION.md)
